...
import static jhm.ufam.br.epulum.Classes.CriarUsuarioTask.MD5;
...
//    private String email;
    ...
    CriarUsuarioTask mAuthTask = null;
    LoginUsuarioTask mLoginTask = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Debug", " passei pelo Main activity");
...
//                .into(photoImageView);
        ...
        GraphRequest request = GraphRequest.newMeRequest(currentAccessToken, new GraphRequest.GraphJSONObjectCallback() {
            ...
            public void onCompleted(JSONObject object, GraphResponse response) {
                ...
                try {
                    ...
                    Log.d("debug", " id: " + id +" email: "+ email + " nome: " + nome + "foto: " + photoUrl );
                    Log.d("debug", "antes do new loginUsuarioaTask");

                    mLoginTask = new LoginUsuarioTask(email,"123456");
                    if(!mLoginTask.execute((Void) null).get()){
                        mAuthTask = new CriarUsuarioTask(email,nome,MD5(nome.charAt(0) + nome.charAt(1) + "123"));
    ...
    public void downloadFile(String uRl) {
        try {
            ...
            File direct = new File(Environment.getExternalStorageDirectory().getAbsolutePath()
                    + "/Epulum"+uRl.substring(uRl.lastIndexOf("/")));
            if(!direct.exists()) {
